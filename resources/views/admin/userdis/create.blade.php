                            ...
                            <div class="tab-pane active" id="home">
                                ...
                                <div class="col-md-10 data">
                                   <select class="form-control" name="user_id">
                                       ...
                                       <option value="{{$itme->user_id}}">{{$itme->user_name}}</option>
                                       @endforeach
                                   </select>
                                </div>
                                ...
                                <div class="col-md-10 data">
                                   <select class="form-control" name="dis_id">
                                       ...
                                       <option value="{{$itme->dis_id}}">{{$itme->dis_name}}</option>
                                       @endforeach
                                   </select>
                                </div>
                                ...
                                <div class="row data-type">
                                   ...
                                   <div class="col-md-10 data">
                                       <input type="datetime-local" class="form-control" name="timeout" id="cate_name" value="">
                                   </div>
