                            ...
                            <div class="tab-pane active" id="home">
                                ...
                                <div class="col-md-10 data">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control price"  placeholder="价格" name="goods_price">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-10 data">
                                    <input type="text" class="form-control" name="goods_num"    placeholder="商品数量" value="">
                                </div>

                                <div class="col-md-2 title">商品简介</div>
                                <div class="col-md-10 data">
                                    <textarea class="form-control" name="goods_desc" placeholder="商品简介" value=""></textarea>
                                </div>
                                ...
                                <div class="col-md-10 data">
                                    <input type="text" class="form-control" name="goods_score"    placeholder="商品积分" value="">
                                </div>
