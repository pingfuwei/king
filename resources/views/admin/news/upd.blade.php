                ...
                <div class="tab-pane active" id="home">
                    <div class="row data-type">
                        ...
                        <div class="col-md-10 data">
                            <input type="text" class="form-control"  name="notice"  placeholder="通知" value="{{$res->notice}}">
                        </div>

                        <div class="col-md-2 title">详情</div>
                        <div class="col-md-10 data">
                            <input type="text" class="form-control" name="desc"  placeholder="详情" value="{{$res->desc}}">
                        </div>

                        <div class="col-md-2 title">标题</div>
                        <div class="col-md-10 data">
                            <input type="text" class="form-control" name="title"  placeholder="标题"value="{{$res->title}}">
                            <input type="hidden" class="form-control" name="n_id"  placeholder="标题"value="{{$res->n_id}}">
                        </div>

                        <div class="col-md-2 title">是否显示</div>
                        <div class="col-md-10 data">
                            <input type="radio" name="is_show"  placeholder="标题" value="1" {{$res->is_show==1?'checked':''}}>是&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" name="is_show"  placeholder="标题" value="0" {{$res->is_show==0?'checked':''}}>否
                        </div>
                    </div>
