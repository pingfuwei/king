                ...
                <div class="body userInfo">
                    ...
                    <div class="tab-content ">
                        <div id="one" class=" active">
                            <form  class="sui-form form-horizontal" action="{{url('index/address/addDo')}}" method="post">
                                <div class="control-group">
                                    <label for="inputName" class="control-label">姓名：</label>
                                    <div class="controls">
                                        <input type="text" id="inputName" class="tel user_name" name="address_name" placeholder="姓名">
                                        <b style="color:red"></b>
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="detail" class="details"></textarea>
                                        <b style="color: red"></b>
                                    </div>
                                </div>
                                <div class="control-group">
