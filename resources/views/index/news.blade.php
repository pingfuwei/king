...
<div class="mod_container " >
    ...
    <script>window['_REPORT_']['FS'] = new Date();</script>
    ...
    <script>
        (function(window){
            ...
            window.data['cms_header'] = {
                setting: [{"NAME":"\u4eac\u4e1c\u5feb\u62a5","URL":"\/\/kuaibao.jd.com","YFLAG":"0"}]
            };
        })(window);
    </script>
    <div class="o2data-lazyload cms_header" style="min-height:100px" id="cms_header" data-id="cms_header" data-tpl="//static.360buyimg.com/mtd/pc/cms/floors/cms_header_tpl.min.js"></div><!--channle_floor_ok-->
