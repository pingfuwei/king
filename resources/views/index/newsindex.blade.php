    ...
    <div style="width:100%; background-color:#eee; height: 2000px;">
        <div style="width: 1200px; margin: 0 auto; padding-bottom: 30px;">
            <div style="padding-top:20px;padding-bottom: 15px;height: 50px;">
                ...
                <br>
                <br>
                <a href="{{url('/index/news/index/'.$res->n_id)}}" style="color: #999; margin-left: 760px;"><b style="font-size:18px; color: #303030;"> 更多{{$res->notice=="推荐"?"热议":"推荐"}} </b></a>
            </div>
            <div style="width: 1200px;">
                <div style="width: 750px; padding-top:5px; background-color:white; height:100%; float: left;">
                    @foreach($goods as $key=>$v)
                    <div style="padding-left: 90px; padding-right: 90px; height: 350px;">
                        <h4>&nbsp; </h4>
                        <h4>&nbsp; </h4>
                        <h4>&nbsp; </h4>
                        ...
                        <ul class="yui3-g Recommend" style="width: 750px; margin-left: -90px; background-color:white; margin-top: -15px;">
                            <li class="yui3-u-5-24" style="margin-left: 90px;">
                                <a href="/index/goods/desc/?goods_id={{$v->goods_id}}" target="_blank"><img src={{env("UPLOADS_URL")}}{{$v->goods_img}} width="200px"/></a>
                            </li>
                            <li class="yui3-u-5-24" style="margin-left: 30px; width: 300px; margin-top: 25px;">
                                <a href="/index/goods/desc/?goods_id={{$v->goods_id}}" target="_blank" style="font-size: 12px;">{{$v->goods_name}}</a>
                                <br>
                                <br>
                                <b><a href="/index/goods/desc/?goods_id={{$v->goods_id}}" target="_blank" style="color: red;">￥：{{$v->goods_price}}</a></b>
                                <br>
                                <h5>&nbsp;</h5>
                                <a href="/index/goods/desc/?goods_id={{$v->goods_id}}"> <button type="button" class="btn btn-danger">立即购买</button></a>
                            </li>
                        </ul>
                    </div>
                    @endforeach
                </div>
                <div style="background-color:white; width: 400px; height: 900px; float: left; margin-left: 10px;">
                    <div style="margin-left: 30px; margin-right: 32px; margin-top: 20px ;height: 350px;">
